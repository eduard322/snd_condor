...
#     ut.bookHist(h,'posZ','z',2000,0.,500.)
...
# #  h['posZ'].Draw()
#  for canvas in ['hitmaps','signal','mult', 'positions', 'tdc']:
#       h[canvas].Update()
...
#     ut.bookCanvas(h,'cluster',' ',1024,768,1,2)
#     h['cluster'].cd(1)
#     h['clX'].Draw()
#     h['cluster'].cd(2)
#     h['clY'].Draw()
#     myPrint(h["slopes"], "Scifi-slopes")
#     myPrint(h['cluster'], "Scifi-cluster")
